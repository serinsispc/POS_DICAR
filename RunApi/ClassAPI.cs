...
namespace RunApi
{
    public class ClassAPI
    {
        ...
        //public string UrlEndPoint { get; set; } = "https://www.serinsispc.com/ApiParqueadero";
        public string UrlEndPoint { get; set; } = "https://localhost:7056";
        ...
        {
            if (NombreDB == null) NombreDB = "DBDicarDistribuciones";
