    ...
    public partial class frmAsignarSede : Form
    {
        ...
        private void btnAsignar_Click(object sender, EventArgs e)
        {
               ...
               cmbUsuario.Text != "")
            {
                ...
                objSedeAsignada = controladorSedeAsignada.consultarUsuarioSede(Convert.ToInt32(cmbUsuario.SelectedValue),Convert.ToInt32(cmbSede.SelectedValue));
                if (objSedeAsignada != null)
                {
                    ...
                    {
                        bool eliminar = controladorSedeAsignada.CrearEditarEliminanrSedeAsignada(objSedeAsignada, 2);
                        if (eliminar == true)
                        {
                ...
                else
                {
                    ...
                    bool crear = controladorSedeAsignada.CrearEditarEliminanrSedeAsignada(objSedeAsignada, 0);
                    if (crear == true)
                    {
